...
This is an R Notebook which reproduces the analysis, tables and figures of the working paper "MetaMetaZipf. What do analyses of city size distributions have in common?". The data is stored on the [MetaZipf](https://github.com/ClementineCttn/MetaZipf) GitHub repository.
