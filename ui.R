  ...
  navlistPanel(
    ...
    tabPanel("Presentation",
            ...
            "This application aims at presenting a meta-analysis of Zipf's law estimations from the literature in an interactive way. Following the meta-analysis proposed by V. Nitsch in 2005, 
             ...
             "The current database covers 1121 estimations from 60 studies, spanning from 1600 to 2011 in more than 80 countries. It is available here: https://github.com/ClementineCttn/MetaZipf."),
